     ...
     <div className="p-4">
       <Container>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
         {habits.map((habit) => (
           <div key={habit._id} className="  bg-gradient-to-br from-slate-800 via-purple-800 to-slate-900 rounded-2xl shadow-xl overflow-hidden hover:scale-105 transition-transform duration-300  ">
             {/* Image Section */}
             ...
             <div className="p-5">
               ...
               {/* Habit Title */}
               <h3 className="text-white text-xl font-bold mb-2">{habit.habitTitle}</h3>
